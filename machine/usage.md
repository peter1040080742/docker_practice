...
> 注意，必须事先在 `Hyper-V` 管理器中新建一个 **外部虚拟交换机** ，具体可以参考https://docs.microsoft.com/zh-cn/virtualization/hyper-v-on-windows/quick-start/connect-to-network
执行下面的命令时，使用 `--hyperv-virtual-switch=MY_SWITCH` 指定虚拟交换机名称
